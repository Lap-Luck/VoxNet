...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button Wybierz,
      ...
      @NonNull GLSurfaceView glSurfaceView, @NonNull EditText nazwa,
      @NonNull TableLayout tableLayout, @NonNull TextView textView, @NonNull EditText zawartosc) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, Wybierz, Wynik, Zapisz, buttonAdd,
          ...
          glSurfaceView, nazwa, tableLayout, textView, zawartosc);
    }
